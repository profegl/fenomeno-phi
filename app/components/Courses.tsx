      ...
      <div className="courses-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="course-card">
          ...
          <div className="course-body">
            ...
            <div className="course-info">
              ...
              <video src="./assets/img/tALLER Robótica kids (2).mp4" autoPlay loop  muted playsInline></video>
            </div>
        ...
        <div className="course-card">
          ...
          <div className="course-body">
            ...
            <div className="course-info">
              <video src="./assets/img/tALLER Robótica kids (1).mp4" autoPlay loop  muted playsInline></video>
            </div>
